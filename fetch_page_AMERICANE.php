...
<img src="includes/contraer41.png" id="ocultar20" style="cursor:pointer;"/>&nbsp;&nbsp;&nbsp; FILTRO  <a style="color:red;font:12px">    (AMERICAN EXPRESS)</a></p></strong></div>
...
<td width="20%" align="center">
	<span>Mostrar</span>
	<select  class="form-select mb-3" id="per_page" onchange="load1(1);">
...
<td width="20%" align="center">					
	<button  class="btn btn-sm btn-outline-success px-5" type="button" onclick="load1(1);"  href="javascript:void(0);" >BUSCAR/RESET</button>
</td>
...
<?php 
require "clasesAMERICANE/script.filtro.php";
?>