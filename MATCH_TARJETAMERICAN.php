...
<img src="includes/contraer41.png" id="ocultar2" style="cursor:pointer;"/>&nbsp;&nbsp;&nbsp;MATCH CON ESTADO DE CUENTA&nbsp;&nbsp;  <a style="color:red;font:12px">    (AMERICAN EXPRESS YA VERIFICADOS)</a></p></strong>


<div  id="mensajeMATCH2AMERICANE">
...
<tr>
    ...
    <th style="background:#ebf8fa; text-align:left" scope="col">INSTITUCIÓN BANCARIA&nbsp;  <a style="color:red;font:12px">AMERICAN EXPRESS</a></th>
<td><input  name="view" value="VER LISTA"  id="<?php echo $row["id"]; ?>" name="view"  class="btn btn-sm btn-outline-danger px-5 view_AMERICANE"/></td>
<tr>
